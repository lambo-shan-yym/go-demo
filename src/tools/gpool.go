...
var (
	// ErrClosed is the code when the client pool is closed
	ErrClosed = errors.New("grpc pool: client pool is closed")
	// ErrTimeout is the code when the client pool timed out
	ErrTimeout = errors.New("grpc pool: client pool timed out")
	// ErrAlreadyClosed is the code when the client conn was already closed
	ErrAlreadyClosed = errors.New("grpc pool: the connection was already closed")
	// ErrFullPool is the code when the pool is already full
...
// and the timeout for the idle clients. Returns an code if the initial
...
// be passed to the factory method during initialization. Returns an code if the
...
func (p *Pool) Get(ctx context.Context) (*ClientConn, error) {
	...
	if wrapper.ClientConn == nil {
		...
		if err != nil {
			// If there was an code, we want to put back a placeholder
...
// but will return an code after first time
